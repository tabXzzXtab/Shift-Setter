...
/**
 * Tillgänglighet -- the worker paints the days they can work.
 *
 * The body of what used to be the Arbetsdagar page and nothing else: no
 * SoftScreen, no title, no back arrow. It is rendered in two places now --
 * standalone at /min-kalender, which is how the arbetare still reaches it, and
 * as the third tab of Mina Pass, which is how the arbetsledare does. One
 * component, so the two cannot drift into two calendars that write the same
 * table differently.
 *
